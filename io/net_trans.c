...
static int transportDirectReadFunction( INOUT_PTR STREAM *stream, 
...
CHECK_RETVAL STDC_NONNULL_ARG( ( 1, 2, 4 ) ) \
static int transportDirectWriteFunction( INOUT_PTR STREAM *stream, 
...
static int transportVirtualConnectFunction( INOUT_PTR NET_STREAM_INFO *netStream, 
...
STDC_NONNULL_ARG( ( 1 ) ) \
static void transportVirtualDisconnectFunction( INOUT_PTR NET_STREAM_INFO *netStream, 
...
CHECK_RETVAL STDC_NONNULL_ARG( ( 1 ) ) \
static int transportVirtualCheckFunction( INOUT_PTR NET_STREAM_INFO *netStream )
	{
	assert( isWritePtr( netStream, sizeof( NET_STREAM_INFO ) ) );
...
static int transportVirtualGetErrorInfo( INOUT_PTR NET_STREAM_INFO *netStream,
...
CHECK_RETVAL STDC_NONNULL_ARG( ( 1, 2, 4 ) ) \
static int transportVirtualReadFunction( INOUT_PTR NET_STREAM_INFO *netStream,
...
CHECK_RETVAL STDC_NONNULL_ARG( ( 1, 2, 4 ) ) \
static int transportVirtualWriteFunction( INOUT_PTR NET_STREAM_INFO *netStream,
...
static int processIncompleteWrite( INOUT_PTR NET_STREAM_INFO *netStream, 
