...
/* PGP signature subpacket types.  Post-4880 drafts also define additional
   packet types, currently commented out */
...
typedef enum {
	...
	PGP_SUBPACKET_KEYID,		/* Issuer key ID (v1-4) */
...
#if 0	/* Post-4880 additions */
	PGP_SUBPACKET_FINGERPRINT,	/* Issuer fingerprint (v5) */
	PGP_SUBPACKET_RESERVED_34,	/* Reserved */
	PGP_SUBPACKET_RECIP_FINGERPRINT, /* Intended recipient fingerprint */
	PGP_SUBPACKET_RESERVED_36,	/* Reserved */
	PGP_SUBPACKET_RESERVED_37,	/* Reserved */
	PGP_SUBPACKET_RESERVED_38,	/* Reserved */
	PGP_SUBPACKET_PREF_AEAD,	/* Preferred AEAD ciphersuites */
#endif /* 0 */
